        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoxOffice = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Actings", x => new { x.ActorID, x.MovieID });
                    table.ForeignKey(
                        name: "FK_Actings_Actors_ActorID",
                        column: x => x.ActorID,
                        principalTable: "Actors",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Actings_Movie_MovieID",
                        column: x => x.MovieID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AwardMovies_Awards_AwardID",
                        column: x => x.AwardID,
                        principalTable: "Awards",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AwardMovies_Movie_MovieID",
                        column: x => x.MovieID,
                        principalTable: "Movie",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AwardMovies_AwardID",
                table: "AwardMovies",
                column: "AwardID");

            migrationBuilder.CreateIndex(
                name: "IX_AwardMovies_MovieID",
                table: "AwardMovies",
                column: "MovieID");
